...
<?php
require_once(Directories::GetFilePath("app/resources/views/includes/navbar.php"));
?>
<div class="container">
    ...
    <div class="faq-admin__space-items">
        <?php require_once(Directories::GetFilePath("app/resources/views/includes/forms/adminreply.php")) ?>
    </div>
</div>